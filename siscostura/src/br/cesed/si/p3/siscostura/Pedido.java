...
/**
 * Classe concreta do tipo Pedido, implementada pela classe identificável
 * @author Neto
 *
 */
public class Pedido implements Identificavel {
	...
	/**
	 * Metodo adiciona o valor da variável itemPedido do tipo ItemPedido ao array listaItensPedidos
	...
	/**
	 * Metodo retorna a variável cliente do tipo Cliente
	...
	/**
	 * Metodo altera o valor da variável cliente do tipo Cliente
	...
	/**
	 * Metodo retorna o valor da variável funcionario do tipo Funcionario
	...
	/**
	 * Metodo altera o valor da variável funcionario do tipo FUncionario
	...
	/**
	 * Metodo retorna o valor da variável statusPedido do tipo StatusPedido
	...
	/**
	 * Metodo altera o valor da variável statusPedido do tipo StatusPedido
	...
	/**
	 * Metodo retorna o valor da variável id do tipo inteiro
	 * @return id id
	 */
	public int getId() {
		return id;
	...
	/**
	 * Metodo altera o valor da variável id do tipo inteiro
	 * @param id id
	 */
